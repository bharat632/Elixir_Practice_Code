defmodule CalculatorProcess do
  def start do
    spawn(fn -> loop(0) end)
  end
  ...
  def error(server_pid ) , do: send(server_pid , "Bharat")
...
# async_fn = fn x ->
#   spawn(fn -> IO.inspect(sync_fn.("test #{x}")) end)
# end
...
#       x * x
#   after
#     5000 -> IO.inspect("Message not received")
#   end
